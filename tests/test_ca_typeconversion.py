...
def test1():
    RunTest(pvlist, use_preempt=True, use_numpy=True, use_time=False, use_ctrl=False)
    RunTest(pvlist, use_preempt=True, use_numpy=True, use_time=False, use_ctrl=True)
    RunTest(pvlist, use_preempt=True, use_numpy=True, use_time=True, use_ctrl=False)

def test2():
    RunTest(pvlist, use_preempt=True, use_numpy=False, use_time=False, use_ctrl=False)
    RunTest(pvlist, use_preempt=True, use_numpy=False, use_time=False, use_ctrl=True)
    RunTest(pvlist, use_preempt=True, use_numpy=False, use_time=True, use_ctrl=False)

def test3():
    RunTest(pvlist, use_preempt=False, use_numpy=True, use_time=False, use_ctrl=False)
    RunTest(pvlist, use_preempt=False, use_numpy=True, use_time=False, use_ctrl=True)
    RunTest(pvlist, use_preempt=False, use_numpy=True, use_time=True, use_ctrl=False)

def test4():
    RunTest(pvlist, use_preempt=False, use_numpy=False, use_time=False, use_ctrl=False)
    RunTest(pvlist, use_preempt=False, use_numpy=False, use_time=False, use_ctrl=True)
    RunTest(pvlist, use_preempt=False, use_numpy=False, use_time=True, use_ctrl=False)
