...
#html_title = None
html_title = 'Epics Instruments Application'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Epics Instruments'
...
latex_documents = [
    ('index', 'EpicsInstruments.tex', u'Epics Instruments Documentation',
