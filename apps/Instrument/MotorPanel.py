...
from epics.wx.wxlib import pvText, pvFloatCtrl, pvTextCtrl, \
     DelayedEpicsCallback, EpicsFunction, set_float, pvCtrlMixin
...
class MotorPanel(wx.Panel):
    ...
    def CreatePanel(self,style='normal'):
        ...
        self.rbv  = pvText(self, size=(70, -1),
                             style=wx.ALIGN_CENTER_VERTICAL|wx.RIGHT|wx.ST_NO_AUTORESIZE)
        ...
        self.__sizer.AddMany([(spacer,        0, wx.ALIGN_CENTER),
                              (self.desc,     1, tstyle|wx.ALIGN_LEFT),
                              (self.info,     1, tstyle|wx.ALIGN_CENTER),
                              (self.rbv,      0, tstyle|wx.ALIGN_CENTER),
